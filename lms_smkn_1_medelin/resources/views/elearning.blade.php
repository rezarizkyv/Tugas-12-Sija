        ...
        <div class="bg-white rounded-3xl border border-slate-200/80 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col justify-between">
            <div>
                ...
                <div class="p-6">
                    ...
                    <!-- Stats Row -->
                    <div class="grid grid-cols-2 gap-3 mt-4 p-3 rounded-2xl bg-slate-50 border border-slate-100 text-xs">
            ...
            <div class="p-6 pt-0">
                <button class="w-full py-2.5 rounded-2xl bg-slate-900 hover:bg-blue-600 text-white font-bold text-xs shadow transition-all flex items-center justify-center gap-2">
                    <i class="fa-solid fa-folder-open"></i> Buka Kelas & Modul
                </button>
            </div>
        </div>
        @endforeach
